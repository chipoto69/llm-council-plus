...
async def stage1_collect_responses(user_query: str, search_context: str = "", request: Any = None, models_override: "List[str] | None" = None, history: "List[Dict[str, str]] | None" = None, trace_ctx: "Optional[TraceContext]" = None) -> Any:
    """
    ...
    try:
        ...
        if trace_ctx is not None:
            ...
            trace_stage(
                ...
                chairman_model,
                input_data={"messages": messages},
                output_data={"model": chairman_model, "response": final_response, "error": False},
            )
        ...
        if trace_ctx is not None:
            ...
            trace_stage(
                trace_ctx,
                "stage3.chairman",
                chairman_model if 'chairman_model' in dir() else "unknown",
                input_data={"messages": messages if 'messages' in dir() else []},
